...
class User extends BaseUser
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="LG\UserBundle\Entity\Role")
     */
    private $role;
     ...
     * Set role
     *
     * @param LG\UserBundle\Entity\Role $role
     */
    public function setRole(\LG\UserBundle\Entity\Role $role)
    {
        $this->role = $role;
    }
     ...
     * Get role
     *
     * @return LG\UserBundle\Entity\Role 
     */
